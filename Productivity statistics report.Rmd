...
top_5_industry_prod_data <- data[data$Period == "2022.03" & data$Measure == "Index" & data$Group == "Productivity Indexes - Industry Level (ANZSIC06)",]

ggplot(data=top_5_industry_prod_data, aes(x=Industry, y=Data_value)) + 
  geom_col()
```
